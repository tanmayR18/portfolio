...
const AboutPage = () => {
  ...
  return (
    ...
    >
      {/* CONTAINER */}
      <div
        className=" h-full overflow-y-scroll lg:flex justify-between p-2 lg:p-0 lg:pl-[10vw] gap-x-5"
        style={{
          scrollbarWidth: "none",
      ...
      >
        ...
        <div className="  flex flex-col gap-28 w-full lg:w-1/2 pt-20">
          {/* BIOGRAPHY CONTAINER */}
            ...
            >
              {skills.map((skill, index) => (
                <motion.div
                  ...
                  key={index}
                  className=" rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:font-semibold hover:text-black"
                >
                  {skill}
                </motion.div>
              ))}
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div
                    href={
                      "https://drive.google.com/file/d/1FM_h2ya6Q656zOp_piKTVWYue5l3xjrF/view?usp=sharings"
                    }
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Learning Web Development from Udemy and Love Babar&apos;s
                    Dot batch.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
